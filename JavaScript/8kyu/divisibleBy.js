...
function divisibleBy(anArray, divisor){

  //filters array and returns the number that are divisible by the divisor

  return anArray.filter(number => number % divisor === 0);
